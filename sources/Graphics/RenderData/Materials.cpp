...
ShaderProgram& BasicMaterial::shader() {
    static auto shader = ShaderProgram(VertexShaderFile(basic_vert), FragmentShaderFile(basic_frag));
    return shader;
}
ShaderProgram& PositionMaterial::shader() {
    static auto shader = ShaderProgram(VertexShaderFile(basic_vert), FragmentShaderFile(position_frag));
    return shader;
}
ShaderProgram& DepthMaterial::shader() {
    static auto shader = ShaderProgram(VertexShaderFile(basic_vert), FragmentShaderFile(depth_frag));
    return shader;
}
ShaderProgram& NormalMaterial::shader() {
    static auto shader = ShaderProgram(VertexShaderFile(basic_vert), FragmentShaderFile(normal_frag));
    return shader;
}
ShaderProgram& PhongMaterial::shader() {
    static auto shader = ShaderProgram(VertexShaderFile(basic_vert), FragmentShaderFile(phong_frag));
    return shader;
}
