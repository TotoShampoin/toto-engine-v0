...
void renderImgui(Core::Window& window, TestData& data, const std::vector<std::string>& logs) {
...
void render(Core::Window& window, TestData& data, const std::vector<std::string>& logs) {
